...
function App() {
    ...
    return (
        <>
            <h1 className="flex w-full items-start justify-center mt-[5rem] mb-4 text-3xl font-extrabold dark:text-indigo-800 md:text-5xl lg:text-6xl">
                <span className="text-transparent bg-clip-text bg-gradient-to-r to-violet-600 from-blue-900">
                    Deep Learning Model to Detect Alzheimer's
                </span>
            </h1>
            {/* <p className="text-lg font-normal text-black lg:text-xl">
                Upload the MRI image to detect.
            </p> */}
            <form onSubmit={handleSubmit}>
                ...
                <span className="flex w-full items-start justify-center text-black">File Uploaded : {filename}</span>
            ...
            <div className=" mt-[5rem] mb-4 text-2xl">
                <span className="flex w-full items-start justify-center text-transparent bg-clip-text bg-gradient-to-r to-violet-600 from-blue-900 font-black">
                    Alzheimer's stage is : {val}
                </span>
            </div>
        </>
    );
